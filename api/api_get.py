...
def transform_single_charge_point(raw_point: Dict[str, Any]) -> tuple[Optional[ChargePointSummary], Optional[str]]:
    """
...
def transform_to_simplified_schema(raw_data: Any) -> tuple[Optional[List[ChargePointSummary]], Optional[str]]:
    """
    ...
    try:
        ...
        # Handle if it's a single object
            ...
            print(f"📍 Processing single charge point...")
